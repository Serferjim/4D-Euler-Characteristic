...
try     
    ...
    if define_orientation
        ...
        assert(iscell(headerInfo.spacedirections), 'spacedirections field in headerInfo should be a cell array of strings for code compatibility, e.g. {''(1,0,0)'' ''(0,2,0.1)'' ''none''  ''(0.1,0.1,1.1)''} for 3 world space dimensions.')
